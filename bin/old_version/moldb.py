	...
	def parseLines(self,lines,currline):
		...
		if words[0]=='USE':
			...
			currline = nextLine;
                ...
                if not 'NewHash' in Params.params:
			sys.stderr.write('WARNING: OldHash is used! (potentially wrong for omograms etc.). Consider adding "USE NewHash" after RUN METHOD statetemt\n')
